...
import phoenixclient.FeaturedServer;
...
public class ServerList
{
    ...
    private void loadFeaturedServers() {
    	...
    	this.addServerData(new FeaturedServer("Micro Craft", "play.micro-craft.ml"));
    	this.addServerData(new FeaturedServer("Hypixel", "hypixel.net"));
    	this.addServerData(new FeaturedServer("BlocksMC", "play.blocksmc.com"));
    ...
    public int getFeaturedServerCount() {
    	...
    	for(ServerData sd : this.servers) {
    		if (sd instanceof FeaturedServer) {
    			count ++;
    		}
    ...
    public void saveServerList()
    {
        try
        {
            ...
            {
            	if(!(serverdata instanceof FeaturedServer)) {
